...
val modId: String = "lambdynforge"

base {
    archivesName.set("LamnDynForge-$minecraftVersion")
    group = "llamastein.lambdynforge"
    version = modVersion
}
...
mixin {
    add(sourceSets.main.get(), "lambdynforge.refmap.json")
}
